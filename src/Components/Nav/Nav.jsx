...
export const Nav = () => {
    ...
    return (
        <div className="px-14 py-5 mx-auto bg-gray-800 text-white md:mb-0 mb-[150px] md:w-full">
                ...
                <ul className="flex items-center hidden space-x-8 lg:flex">
                    ...
                    <li>
                        <Link
                            ...
                            aria-label="Our product"
                            title="Our product"
                            className="font-medium tracking-wide text-white transition-colors duration-200 hover:text-purple-700">
                            Statistics
                        </Link>
                    </li>
                    <li>
